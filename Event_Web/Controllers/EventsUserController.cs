...
namespace Event_Web.Controllers
{
    public class EventsUserController : BaseController//GenericRepository<Event>
    {
        ...
        public EventsUserController(IEventService eventService, Kariyer_ProjeContext context)
        {
    ...
    //    private readonly Kariyer_ProjeContext _context;
    //    //Event_WebUser event_WebUser;
    //    public EventsUserController(Kariyer_ProjeContext context)
    //    {
    //        _context = context;
    ...
    //    [HttpPost]
    //    [ValidateAntiForgeryToken]
    //    public async Task<IActionResult> Edit(int id, [Bind("EventId,EventName,EventDate,EventLastApplicationDate,EventDescription,CityId,EventAddress,EventQuota,CategoryId,UserId,IsFree")] Event @event)
    //    {
    //        if (id != @event.EventId)
    //        {
    //            return NotFound();
