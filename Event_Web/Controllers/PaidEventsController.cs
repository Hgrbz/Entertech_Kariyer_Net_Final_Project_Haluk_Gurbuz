...
{
    public class PaidEventsController : BaseController
    {

        private readonly Kariyer_ProjeContext _context;
      
        public PaidEventsController(Kariyer_ProjeContext context)
        {
            _context = context;          
        ...
        public async Task<IActionResult> Create([Bind("EventId,EventName,EventDate,EventLastApplicationDate,EventDescription,CityId,EventAddress,EventQuota,CategoryId,TicketFee")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventId,EventName,EventDate,EventLastApplicationDate,EventDescription,CityId,EventAddress,EventQuota,CategoryId,UserId,TicketFee")] Event @event)
        {
            if (id != @event.EventId)
            {
                return NotFound();
